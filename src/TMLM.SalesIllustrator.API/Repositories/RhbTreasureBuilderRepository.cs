...
namespace TMLM.SalesIllustrator.API.Repositories
{
    ...
    {
        public async Task<RepositoryResult<string>> Update(UpdateSiInputModel model)
        {
            ...
            await base.DbConnection.ExecuteAsync("spUpdate_RhbTreasureBuilder", _dParams, commandType: CommandType.StoredProcedure);
