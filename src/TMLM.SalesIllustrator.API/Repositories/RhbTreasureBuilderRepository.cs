...
{
    public class RhbTreasureBuilderRepository : BaseRepository, IRhbTreasureBuilderRepository
    {
        public async Task<RepositoryResult<string>> Update(UpdateUserSiInputModel model)
        {
            ...
            var RetVal = await base.DbConnection.QueryFirstOrDefaultAsync<RTBUserDetailsModel>("spUpdate_RhbTreasureBuilder", _dParams, commandType: CommandType.StoredProcedure);
        ...
        public async Task<RepositoryResult<string>> Create(CreateUserSiInputModel model)
        {
            RepositoryResult<string> resp = new();
            ...
            base.OpenConnection(Constant.ConnectionString);
            var RetVal = await base.DbConnection.QueryFirstOrDefaultAsync<string>("spCreate_RhbTreasureBuilder", _dParams, commandType: CommandType.StoredProcedure);
        ...
        public async Task<RepositoryResult<string>> UpdateProcess(UpdateProcessSiInputModel model)
        {
            ...
            base.OpenConnection(Constant.ConnectionString);
            await base.DbConnection.ExecuteAsync("spUpdateProcess_RhbTreasureBuilder", _dParams, commandType: CommandType.StoredProcedure);
