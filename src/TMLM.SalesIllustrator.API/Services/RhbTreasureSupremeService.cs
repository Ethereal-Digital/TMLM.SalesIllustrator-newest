...
{
    public class RhbTreasureSupremeService : IRhbTreasureSupremeService
    {
        private static IRhbTreasureSupremeRepository repo;
        private static IUserSessionRepository userSessionRepo;
        private static IUserTokenService agencyTokenService;

        public RhbTreasureSupremeService(IRhbTreasureSupremeRepository _repo, IUserSessionRepository _userSessionRepo, IUserTokenService _agencyTokenService)
        {
            repo = _repo;
        ...
        public async Task<string> Create(CreateSupremeInputModel model)
        {
        ...
        public async Task<string> Update(UpdateSupremeInputModel model)
        {
